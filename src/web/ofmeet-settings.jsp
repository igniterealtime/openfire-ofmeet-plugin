...
<%
    ...
    String enabledTitle = LocaleUtils.getLocalizedString("config.page.configuration.enabled", "ofmeet");
    String disabledTitle = LocaleUtils.getLocalizedString("config.page.configuration.disabled", "ofmeet");	
    String clusteringTitle = LocaleUtils.getLocalizedString("config.page.configuration.clustering.title", "ofmeet");	
