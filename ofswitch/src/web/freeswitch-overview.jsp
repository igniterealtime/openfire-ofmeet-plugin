...
<%
	if (JiveGlobals.getBooleanProperty("freeswitch.enabled", true))
	{
		...
		{	
			EslMessage resp = OfSwitchPlugin.self.sendFWCommand("banner");
			...
			if (resp != null)
			{
				...
				resp = OfSwitchPlugin.self.sendFWCommand("sofia status");
				...
				resp = OfSwitchPlugin.self.sendFWCommand("version");
				overviewLines = resp.getBodyLines();
